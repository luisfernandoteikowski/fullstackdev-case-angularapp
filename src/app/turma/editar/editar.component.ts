...
export class EditarComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.turmaService.buscar(this.escolaSelecionada,this.id).subscribe((data: Turma)=>{
      this.turma = data;
    });
  ...
  salvar(){
    this.turmaService.atualizar(this.escolaSelecionada, this.id ,{...this.form.value, escolaId:this.escolaSelecionada}).subscribe(res => {
